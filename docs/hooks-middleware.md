...
The writeup must include cases where each strategy wins (not all hooks win against `caveman-then-llm-self-compact`; not all hooks beat `tier0+tier1`). Bias-free reporting is part of the contract.
